...
AUR_GIT_URL="${AUR_GIT_URL:-ssh://aur@aur.archlinux.org/rune-notes-bin.git}"
AUR_BRANCH="${AUR_BRANCH:-master}"
AUR_COMMIT_NAME="${AUR_COMMIT_NAME:-rune-notes-ci}"
AUR_COMMIT_EMAIL="${AUR_COMMIT_EMAIL:-rune-notes-ci@users.noreply.github.com}"
AUR_PAYLOAD_FILES="${AUR_PAYLOAD_FILES:-PKGBUILD .SRCINFO}"
